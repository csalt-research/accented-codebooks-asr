...
class HubertPretrainingConfig(FairseqDataclass):
    ...
    no_codebook_entries: int = field(
        default=50,
        metadata={"help": "number of codebook entries"},
    )
    no_accents: int = field(
        default=5,
        metadata={"help": "number of codebooks corrosponding to each accent"},
    )
    freeze_codebooks: bool = field(
        default=False,
        metadata={"help": "freeze the codebook"},
    )
