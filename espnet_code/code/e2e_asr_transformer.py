...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad, accent_labels):
        """E2E forward.
        ...
        hs_pad, hs_mask, hs_intermediates = self.encoder(xs_pad, src_mask, accent_labels)
        self.hs_pad = hs_pad
    ...
    def encode(self, x, accent_label):
        ...
        enc_output, _, _ = self.encoder(x, None, accent_labels)
    ...
    def calculate_all_attentions(self, xs_pad, es_pad, ilens, ys_pad):
        ...
        self.eval()
        with torch.no_grad():
            self.forward(xs_pad, es_pad, ilens, ys_pad)
        ret = dict()
    ...
    def calculate_all_ctc_probs(self, xs_pad, es_pad, ilens, ys_pad):
