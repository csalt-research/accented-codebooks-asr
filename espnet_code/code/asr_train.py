...
def get_parser(parser=None, required=True):
    ...
    parser.add(
        ...
        default=None,
        type=str,
        help="used to identify the speaker_conditioned model",
    )
    parser.add_argument(
        "--ngpu",
        default=None,
    ...
    parser.add_argument(
        ...
        default=0.1,
        type=float,
        help="Accent Loss coefficient, "
        "alpha: alpha*accent_score_loss + (1-alpha)*att_ctc_loss ",
    )
    parser.add_argument(
    ...
    # Codebook based cross attention setup related.
    parser.add_argument(
        "--use-codebooks",
        type=strtobool,
        default=False,
        help="The flag to switch to use codebook based system.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Number of accents used during training.",
    )
    
    parser.add_argument(
        "--codebooks-per-accent",
        type=int,
        default=50,
        help="Numebr of codebooks to be used per accent.",
    )
    
    parser.add_argument(
        "--codebook-cross-attention-layers",
        default="",
        type=lambda s: [int(mod) for mod in s.split(",") if s != ""],
        help="List of layers to use codebook based cross attention, separated by a comma.",
    )
