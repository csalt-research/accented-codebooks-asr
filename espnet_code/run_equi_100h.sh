...
data_url=https://voice-prod-bundler-ee1969a6ce8178826482b88e843c335139bd3fb4.s3.amazonaws.com/cv-corpus-7.0-2021-07-21/cv-corpus-7.0-2021-07-21-${lang}.tar.gz
if [ -z ${nbpe} ]; then
  if [[ "zh" == *"${lang}"* ]]; then
    nbpe=2500
  else
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    local/create_mcv_data.sh $csvdir/train_equi_100h.tsv ${datadir}/cv-corpus-7.0-2021-07-21/${lang}/clips/ data/${train_set}
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    python scripts/add_accent_info.py --input-csv $csvdir/train_equi_100h.tsv  --input-json ${feat_tr_dir}/data_${bpemode}${nbpe}.json --output-json ${feat_tr_dir}/data_${bpemode}${nbpe}_with_accent.json 
